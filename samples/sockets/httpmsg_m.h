...
class HTTPMsg : public NetPkt
{
  ...
  public:
    ...
    virtual cPolymorphic *dup() const {return new HTTPMsg(*this);}
...
inline void doPacking(cCommBuffer *b, HTTPMsg& obj) {obj.netPack(b);}
inline void doUnpacking(cCommBuffer *b, HTTPMsg& obj) {obj.netUnpack(b);}
